...
import {
  index_modern_exports,
  init_index_modern
} from "./chunk-LK52EIMF.js";
import {
  __commonJS,
  __esm,
  __export,
...
var require_InstagramEmbed = __commonJS({
  "node_modules/react-social-media-embed/dist/components/embeds/InstagramEmbed.js"(exports) {
    ...
    var InstagramEmbed = (_a) => {
      ...
      const [stage, setStage] = React2.useState(CHECK_SCRIPT_STAGE);
      const uuidRef = React2.useRef((0, uuid_1.generateUUID)());
      const [processTime, setProcessTime] = React2.useState(Date.now());
      const embedContainerKey = React2.useMemo(() => `${uuidRef.current}-${processTime}`, [processTime]);
      const frm = (0, useFrame_1.useFrame)(frame);
      React2.useEffect(() => {
        debug && console.log(`[${(/* @__PURE__ */ new Date()).toISOString()}]: ${stage}`);
      }, [debug, stage]);
      ...
      const placeholder = embedPlaceholder !== null && embedPlaceholder !== void 0 ? embedPlaceholder : React2.createElement(PlaceholderEmbed_1.PlaceholderEmbed, Object.assign({ url: cleanUrlWithEndingSlash, imageUrl: placeholderImageUrl, linkText, spinner: placeholderSpinner, spinnerDisabled: placeholderSpinnerDisabled }, placeholderProps, { style: Object.assign(Object.assign({}, placeholderStyle), placeholderProps === null || placeholderProps === void 0 ? void 0 : placeholderProps.style) }));
      return React2.createElement(
        ...
        React2.createElement(EmbedStyle_1.EmbedStyle, null),
        React2.createElement(
          ...
          React2.createElement("div", { id: uuidRef.current, className: "instagram-media-pre-embed rsme-d-none" }, " ")
        )
      );
    };
  ...
  "node_modules/react-social-media-embed/dist/components/embeds/LinkedInEmbed.js"(exports) {
    ...
    var LinkedInEmbed = (_a) => {
      ...
      return React2.createElement(
        ...
        React2.createElement(EmbedStyle_1.EmbedStyle, null),
        React2.createElement("iframe", { className: (0, classnames_1.default)("linkedin-post", !ready && "rsme-d-none"), src: url, width: "100%", height: !ready ? 0 : height, frameBorder: "0", onLoad: () => setReady(true) }),
  ...
  "node_modules/react-social-media-embed/dist/components/embeds/PinterestEmbed.js"(exports) {
    ...
    var PinterestEmbed = (_a) => {
      ...
      return React2.createElement(
        ...
        React2.createElement(EmbedStyle_1.EmbedStyle, null),
        React2.createElement("iframe", { className: (0, classnames_1.default)("pinterest-post", !ready && "rsme-d-none"), src: `https://assets.pinterest.com/ext/embed.html?id=${postId}`, width: "100%", height: !ready ? 0 : height, frameBorder: "0", scrolling: "no", onLoad: () => setReady(true) }),
        !ready && !placeholderDisabled && placeholder
      );
    };
  ...
  "node_modules/react-social-media-embed/dist/components/embeds/TwitterEmbed.js"(exports) {
    ...
    var TwitterEmbed = (_a) => {
      ...
      return React2.createElement(
        ...
        React2.createElement(EmbedStyle_1.EmbedStyle, null),
        React2.createElement(react_twitter_embed_1.TwitterTweetEmbed, Object.assign({ tweetId, placeholder: placeholderDisabled ? void 0 : placeholder }, twitterTweetEmbedProps))
      );
    };
...
var import_prop_types, import_react, import_fast_deep_equal, import_youtube_player, __defProp, __defProps, __getOwnPropDescs, __getOwnPropSymbols, __hasOwnProp, __propIsEnum, __defNormalProp, __spreadValues, __spreadProps, __async, defaultProps, propTypes, _YouTube, YouTube, YouTube_default;
var init_YouTube_esm = __esm({
  "node_modules/react-youtube/dist/YouTube.esm.js"() {
    ...
    _YouTube = class extends import_react.default.Component {
      constructor(props) {
        super(props);
